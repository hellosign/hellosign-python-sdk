...
class SignatureRequestApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.signature_request_files_as_encoded_string_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/signature_request/files/{signature_request_id}?get_data_uri=1&file_type=pdf',
                'operation_id': 'signature_request_files_as_encoded_string',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.signature_request_files_as_file_url_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/signature_request/files/{signature_request_id}?get_url=1&file_type=pdf',
    ...
    def signature_request_bulk_create_embedded_with_template(
        ...
        **kwargs
        ...
        Creates BulkSendJob which sends up to 250 SignatureRequests in bulk based off of the provided Template(s) specified with the `template_ids` parameter to be signed in an embedded iFrame. These embedded signature requests can only be signed in embedded iFrames whereas normal signature requests can only be signed on HelloSign.  **NOTE**: Only available for Standard plan and higher.  # noqa: E501
    ...
    def signature_request_files_as_encoded_string(
        self,
        signature_request_id,
        **kwargs
    ):
        """Download File as Encoded String  # noqa: E501
        ...
        >>> thread = api.signature_request_files_as_encoded_string(signature_request_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['signature_request_id'] = \
            signature_request_id
        try:
            return self.signature_request_files_as_encoded_string_endpoint.call_with_http_info(**kwargs)
        except ApiException as e:
            if e.status == 200:
                e.body = self.api_client.deserialize(
                    response=MetaDict({'data': e.body}),
    ...
    def signature_request_files_as_file_url(
        ...
        **kwargs
        ...
        """Download File as File Url  # noqa: E501

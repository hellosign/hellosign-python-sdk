...
class ApiAppApi(object):
    ...
    def api_app_list(
        ...
        **kwargs
        ...
        Keyword Args:
            page (int): Which page number of the ApiApp List to return. Defaults to `1`.. [optional] if omitted the server will use the default value of 1
    ...
    def api_app_update(
        ...
        **kwargs
        ...
        """Updates an existing API App.  # noqa: E501

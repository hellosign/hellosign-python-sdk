...
class TemplateApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.template_files_as_encoded_string_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/template/files/{template_id}?get_data_uri=1&file_type=pdf',
                'operation_id': 'template_files_as_encoded_string',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.template_files_as_file_url_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/template/files/{template_id}?get_url=1&file_type=pdf',
    ...
    def template_files_as_encoded_string(
        self,
        template_id,
        **kwargs
    ):
        """Get Template File as Encoded String  # noqa: E501
        ...
        >>> thread = api.template_files_as_encoded_string(template_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['template_id'] = \
            template_id
        try:
            return self.template_files_as_encoded_string_endpoint.call_with_http_info(**kwargs)
        except ApiException as e:
            if e.status == 200:
                e.body = self.api_client.deserialize(
                    response=MetaDict({'data': e.body}),
    ...
    def template_files_as_file_url(
        ...
        **kwargs
        ...
        """Get Template File as File Url  # noqa: E501

...
class SubBulkSignerListSigner(ModelNormal):
    ...
    def _from_openapi_data(cls, role, name, email_address, *args, **kwargs):  # noqa: E501
        """SubBulkSignerListSigner - a model defined in OpenAPI

        Args:
            role (str): Must match the single existing role in chosen Template(s). Currently only templates with a single role are supported. All signers must have the same `role` value.

...
class SubFormFieldsPerDocumentInitials(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SubFormFieldsPerDocumentInitials - a model defined in OpenAPI

        Keyword Args:
            type (str): An input field for initials. Use the `SubFormFieldsPerDocumentInitials` class.. defaults to "initials"  # noqa: E501

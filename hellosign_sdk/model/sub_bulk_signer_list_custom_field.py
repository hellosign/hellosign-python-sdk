...
class SubBulkSignerListCustomField(ModelNormal):
    ...
    def _from_openapi_data(cls, name, value, *args, **kwargs):  # noqa: E501
        """SubBulkSignerListCustomField - a model defined in OpenAPI

        Args:
            name (str): The name of the custom field. Must be the field's `name` or `api_id`.

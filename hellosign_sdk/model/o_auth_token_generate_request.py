...
class OAuthTokenGenerateRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, client_id, client_secret, code, state, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            grant_type (str): When generating a new token use `authorization_code`.. defaults to "authorization_code"  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, client_id, client_secret, code, state, *args, **kwargs):  # noqa: E501
        """OAuthTokenGenerateRequest - a model defined in OpenAPI

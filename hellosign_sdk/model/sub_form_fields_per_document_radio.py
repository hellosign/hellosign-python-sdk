...
class SubFormFieldsPerDocumentRadio(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SubFormFieldsPerDocumentRadio - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            is_checked (bool): `true` for checking the radio field by default, otherwise `false`. Only one radio field per group can be `true`.

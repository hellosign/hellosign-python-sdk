...
class SubUnclaimedDraftEmbeddedTemplateSigner(ModelNormal):
    ...
    def _from_openapi_data(cls, role, name, email_address, *args, **kwargs):  # noqa: E501
        """SubUnclaimedDraftEmbeddedTemplateSigner - a model defined in OpenAPI

        Args:
            role (str): Must match an existing role in chosen Template(s). Multiple signers cannot share the same `role`.
            name (str): The name of the signer filling the role of `role`.
            email_address (str): The email address of the signer filling the role of `role`.

...
class EmbeddedEditUrlRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            preview_only (bool): This allows the requester to enable the preview experience experience.  **Note**: This parameter overwrites `show_preview=true` (if set).. [optional] if omitted the server will use the default value of False  # noqa: E501

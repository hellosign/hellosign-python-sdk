...
class TemplateCreateEmbeddedDraftRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, client_id, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            allow_ccs (bool): This allows the requester to specify whether the user is allowed to provide email addresses to CC when creating a template.. [optional] if omitted the server will use the default value of False  # noqa: E501

...
class SubFormFieldRuleTrigger(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, operator, *args, **kwargs):  # noqa: E501
        """SubFormFieldRuleTrigger - a model defined in OpenAPI

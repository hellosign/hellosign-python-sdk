...
class SubFormFieldsPerDocumentDateSigned(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SubFormFieldsPerDocumentDateSigned - a model defined in OpenAPI

        Keyword Args:
            type (str): A date. Use the `SubFormFieldsPerDocumentDateSigned` class.. defaults to "date_signed"  # noqa: E501

...
class SubFormFieldsPerDocumentCheckboxMerge(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SubFormFieldsPerDocumentCheckboxMerge - a model defined in OpenAPI

        Keyword Args:
            type (str): A checkbox field that has default value set using pre-filled data. Use the `SubFormFieldsPerDocumentCheckboxMerge` class.. defaults to "checkbox-merge"  # noqa: E501
        ...
        type = kwargs.get('type', "checkbox-merge")

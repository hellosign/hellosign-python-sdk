...
class SubAttachment(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, signer_index, *args, **kwargs):  # noqa: E501
        """SubAttachment - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            instructions (str): The instructions for uploading the attachment.. [optional]  # noqa: E501
            required (bool): Determines if the attachment must be uploaded.. [optional] if omitted the server will use the default value of False  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, signer_index, *args, **kwargs):  # noqa: E501
        """SubAttachment - a model defined in OpenAPI

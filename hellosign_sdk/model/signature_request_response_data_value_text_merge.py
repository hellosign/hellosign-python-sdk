...
class SignatureRequestResponseDataValueTextMerge(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """SignatureRequestResponseDataValueTextMerge - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            type (str): A text field that has default text set by the api. [optional] if omitted the server will use the default value of "text-merge"  # noqa: E501
